...
import { HeroBigImage1 } from "../assets/images/jpg";
...
const Courses = () => {
  ...
  return (
    <section className="school-courses">
      ...
      <BackgroundHeroImg
        url={HeroBigImage1}
        title="kurslarimiz orqali o’quvchilar bilimlarni yanada oshirishadi"
      />
        ...
        <div className="container">
          ...
          >
            ...
            <SwiperSlide className="school-courses__card">
              ...
              <div className="school-courses__texts">
                <h2 className="school-courses__texts-title">Kimyo kursi</h2>
                <p className="school-courses__texts-paragraph">
                  The first and only school in Uzbekistan to be a member of
